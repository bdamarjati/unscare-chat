            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$specific->keterangan}}" name="nim_nip"
                            id="nim_nip" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Dosis Ke :</label>
                        <input type="text" class="form-control" value="{{$specific->dosis_ke}}" name="nim_nip"
                            id="nim_nip" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$specific->link}}" name="nim_nip" id="nim_nip"
                            readonly>
                    </div>
                    <br>
