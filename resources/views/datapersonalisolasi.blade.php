						...
						<div class="card">
                            ...
                            <div class="text-center"><i class="bx bxs-user-circle text-primary font-50"></i><h4 class="form-label ">Suspect : {{$specific->nama_lengkap}}</h4>
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" value="{{$specific->alasan}}" name="nim_nip" id="nim_nip" readonly>
                                    </div>
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="text" class="form-control" value="{{$specific->butuh_bantuan}}" name="nim_nip" id="nim_nip" readonly>
									</div>
									<div class="mb-3">
										<label class="form-label">Sudah Dikirim Bantuan ? (Dari UNS) :</label>
										<input type="text" class="form-control" value="{{$specific->kiriman_bantuan}}" name="nim_nip" id="nim_nip" readonly>
									</div>
									<div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{$specific->selesai }}" name="nim_nip" id="nim_nip" readonly>
                                    </div>
